...
class ReservationFormController extends Controller
{
    ...
    public function createReservation(Request $request)
    {
        ...
        if ($request->input()) {
            ...
            if ($reservation) {
                if ($request->input('start_time') == $reservation->start_time) {
                    return redirect()->back()->with('status', 'Tokiu laiku ši zona jau rezervuota')->withInput();
                }
        ...
        return redirect()->route('reservation')->with('success', 'Rezervacija atlikta sėkmingai');
    }
    ...
    public function editReservation(Request $request, Reservation $reservation)
    {
        ...
        return redirect()->route('reservation')->with('success', 'Rezervacija redaguota sėkmingai');
    }
    ...
    $zone = Zone::where('id', $request->input('zone'))->first();
        ...
        return redirect()->route('dashboard')->with('success', 'Rezervacija redaguota sėkmingai');
    }
    ...
    public function deleteReservation(Request $request, Reservation $reservation)
    {
        ...
        return redirect()->route('reservation')->with('success', 'Rezervacija ištrinta');
    }
    ...
    public function deleteReservationFromDashboard(Reservation $reservation)
    {
        ...
        return redirect()->route('dashboard')->with('success', 'Rezervacija ištrinta');
    }
}
